...
class Test3AppTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Test3App)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Test3App)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/test3app/')  # The final '/' is essential for all pages/controllers
